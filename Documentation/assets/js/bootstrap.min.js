...
+(function (a) {
  ...
  +(function (a) {
    ...
    function b(b) {
      return this.each(function () {
        var d = a(this),
          e = d.data('bs.carouselSection'),
          f = a.extend({}, c.DEFAULTS, d.data(), 'object' == typeof b && b),
          g = 'string' == typeof b ? b : f.slide;
        e || d.data('bs.carouselSection', (e = new c(this, f))),
          'number' == typeof b ? e.to(b) : g ? e[g]() : f.interval && e.pause().cycle();
      });
    }
    var c = function (b, c) {
      (this.$element = a(b)),
        (this.$indicators = this.$element.find('.carouselSection-indicators')),
        (this.options = c),
        (this.paused = null),
        (this.sliding = null),
        (this.interval = null),
        ...
        this.options.keyboard &&
          this.$element.on('keydown.bs.carouselSection', a.proxy(this.keydown, this)),
        'hover' == this.options.pause &&
          !('ontouchstart' in document.documentElement) &&
          this.$element
            .on('mouseenter.bs.carouselSection', a.proxy(this.pause, this))
            .on('mouseleave.bs.carouselSection', a.proxy(this.cycle, this));
    };
    (c.VERSION = '3.3.7'),
      ...
      (c.prototype.to = function (a) {
        ...
        if (!(a > this.$items.length - 1 || a < 0))
          return this.sliding
            ? this.$element.one('slid.bs.carouselSection', function () {
                b.to(a);
              })
            : c == a
            ? this.pause().cycle()
      ...
      (c.prototype.slide = function (b, d) {
        ...
        var j = f[0],
          k = a.Event('slide.bs.carouselSection', { relatedTarget: j, direction: h });
        if ((this.$element.trigger(k), !k.isDefaultPrevented())) {
          ...
          var m = a.Event('slid.bs.carouselSection', {
            relatedTarget: j,
            direction: h,
          });
          return (
    ...
    var e = function (c) {
      ...
      if (f.hasClass('carousel')) {
        ...
        h && (g.interval = !1),
          b.call(f, g),
          h && f.data('bs.carouselSection').to(h),
          c.preventDefault();
      }
    };
    a(document)
      .on('click.bs.carouselSection.data-api', '[data-slide]', e)
      .on('click.bs.carouselSection.data-api', '[data-slide-to]', e),
      a(window).on('load', function () {
        a('[data-ride="carouselSection"]').each(function () {
          var c = a(this);
          b.call(c, c.data());
        });
      });
